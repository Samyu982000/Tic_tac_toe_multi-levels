...
/*
 * private function: make the ai player take a novice_1 move,
 * that is: mix between choosing the optimal and suboptimal minimax decisions
 * @param turn [String]: the player to play, either X or O
 */
    function takeA_60_ai_Move(turn) {
        ...
        /*
         * take the optimal action 60% of the time, and take the 1st suboptimal action 60% of the time
         */
        var chosenAction;
...
/*
 * private function: make the ai player take a novice_2 move,
 * that is: mix between choosing the optimal and suboptimal minimax decisions
 * @param turn [String]: the player to play, either X or O
 */
    function takeA_80_ai_Move(turn) {
        ...
        /*
         * take the optimal action 80% of the time, and take the 1st suboptimal action 60% of the time
         */
        var chosenAction;
